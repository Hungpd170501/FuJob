...
import se1621.dao.v2.CategoryDAO;
...
public class JobCategoryController extends HttpServlet {
    ...
    private static final String SUCCESS = "/WEB-INF/viewAdmin/job-category.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<CategoryEntity> listCategory = categoryDAO.getAll("CategoryEntity");
            request.setAttribute("JOB_CATEGORY_LIST", listCategory);
            url = SUCCESS;
        } catch (Exception e) {
            log("Error at JobCategoryController: " + e);
        } finally {
