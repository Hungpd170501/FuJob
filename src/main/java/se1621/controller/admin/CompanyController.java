...
public class CompanyController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Map<Integer, Long> countCompanyByStatus = listAllCompany.stream().filter(e -> e.getCompanyStatus() != null).collect(groupingBy(CompanyEntity::getCompanyStatus, counting()));
