<div class="js-fix-footer footer border-top-2">
    <div class="container page__container page-section d-flex flex-column">
        <p class="text-70 brand mb-24pt">
            <img class="brand-icon" src="${pageContext.request.contextPath}/asset/images/Logo/Logo/Untitled-3.png"
                 width="80" alt="FuJob">
        </p>
                    ...
                    <div class="col-md-2 col-sm-4 mb-24pt mb-md-0">
                        ...
                        <nav class="nav nav-links nav--flush">
                            <a href="#" class="nav-link mr-8pt"><img
                                    src="${pageContext.request.contextPath}/asset/images/icon/footer/facebook-square@2x.png"
                                    width="24"
                                    height="24" alt="Facebook"></a>
                            <a href="#" class="nav-link mr-8pt"><img
                                    src="${pageContext.request.contextPath}/asset/images/icon/footer/twitter-square@2x.png"
                                    width="24"
                                    height="24" alt="Twitter"></a>
                            <a href="#" class="nav-link mr-8pt"><img
                                    src="${pageContext.request.contextPath}/asset/images/icon/footer/vimeo-square@2x.png"
                                    width="24"
                                    height="24" alt="Vimeo"></a>
                        </nav>
                    </div>
