    ...
    <div
        ...
        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
            ...
            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                <h2 class="mb-0">Skills Management</h2>
        ...
        <div class="row mb-32pt">
            <div class="col-lg-4">
                <div class="page-separator">
                    <div class="page-separator__text">Add a new Skill</div>
                </div>
                    ...
                    <div class="card m-0">
                        ...
                        <div class="table-responsive" data-toggle="lists"
                            ...
                            <table class="table mb-0 thead-border-top-0 table-nowrap" id="authorTable">
                                ...
                                <c:forEach items="${requestScope.SKILL_LIST}" var="skillItem">
                                    <tr>
                                        <td class="js-lists-values-id small">${pageScope.skillItem.categoryID}</td>
                                        <td>
                                            <div class="d-flex flex-column">
                                                <input class="form-control" type="text"
                                                       value="${pageScope.skillItem.skillName}"/>
                                                <p class="mb-0"><strong
                                                        class="d-none js-lists-values-job-category-name">${pageScope.skillItem.skillName}</strong>
                                                </p>
                                            </div>
                                        </td>
