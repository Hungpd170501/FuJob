...
<section class="section text-center" name="action">
    <h3 class="text-warning "><%=message%>
    </h3>
    <a href="${pageContext.request.contextPath}/MainController?action=CheckCreateResume&studentID=${sessionScope.LOGIN_USER.userID}">
        <p class="h5" style="text-decoration: underline">Create Your Resume Now</p></a>
</section>
<%
} else {
%>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="candidates-profile-details text-center">
                    <img id="image" src="${requestScope.RESUME.avatar}" height="150" alt=""
                         class="d-block mx-auto shadow rounded-pill mb-4">
                    <h4 class="text-white mb-2"><%=resume.getFullName()%>
                    </h4>
                    <p class="text-white mb-2"><%=resume.getMajor()%>
                    </p>
                    <ul class="list-unstyled social-icon  mb-0">
                        <li class="list-inline-item"><a href="${requestScope.RESUME.website}" class="rounded"><i
                                class="mdi mdi-web"></i></a></li>
                        <li class="list-inline-item"><a href="${requestScope.RESUME.linkedIn}" class="rounded"><i
                                class="mdi mdi-linkedin"></i></a></li>
                        <li class="list-inline-item"><a href="${requestScope.RESUME.gitHub}" class="rounded"><i
                                class="mdi mdi-github-box"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="border rounded p-4">
                    ...
                    <ul class="list-inline pt-3 border-top mb-0 row mt-4">
                        <li class="list-inline-item mr-3 col-md-6">
                            <p href="" class="f-15 mb-0 "><i
                                    class="mdi mdi-map-marker mr-2"></i><strong>Address:</strong> ${requestScope.RESUME.address}
                            </p>
                        </li>
                        <li class="list-inline-item mr-3 col-md-5">
                            <p href="" class="f-15 mb-0"><i
                                    class="mdi mdi-email mr-2"></i><strong>Email:</strong> ${requestScope.RESUME.gmail}
                            </p>
                        </li>

                        <li class="list-inline-item mr-3 col-md-6">
                            <p href="" class="f-15 mb-0"><i
                                    class="mdi mdi-cellphone-iphone mr-2"></i><strong>Phone:</strong> ${requestScope.RESUME.phone}
                            </p>
                        </li>
                        <%
                        ...
                        <li class="list-inline-item mr-3 col-md-5">
                            <p href="" class="f-15 mb-0 "><i
                                    class="mdi mdi-timetable mr-2"></i><strong>Joined:</strong> <%= date%>
                            </p>
                        </li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-lg-12 mt-4 pt-5">
                        <div class="border rounded candidates-profile-education text-center">
                            ...
                            <h6 class="text-uppercase f-17 font-weight-bold " style="letter-spacing: 5px"> FPT
                                UNIVERSITY</h6>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-3">
                                <div class="company-logo-img">
                                    ...
                                    %>
                                    <img src="<%= jobOrder.getJob().getCompany().getAvatar()%>" alt=""
                                         class="img-fluid img-thumbnail mx-auto d-block"
                                         style="width:200px;height:200px">
                                    <%
                                    } else {
                                    %>
                                    <img src="<%= jobOrder.getResume().getAvatar()%>" alt=""
                                         class="img-fluid img-thumbnail mx-auto d-block"
                                         style="width:200px;height:200px">
                                    <%
                                        }
                            ...
                            <div class="col-lg-6 col-md-9">
                                <div class="job-list-desc">
                                    ...
                                    <h4 class="mb-2"><a href=""
                                                        class="text-dark"><%= jobOrder.getJob().getCompany().getCompanyName()%>
                                    </a>
                                    </h4>
                                    <%
                                    } else {
                                    %>
                                    <h4 class="mb-2"><a href=""
                                                        class="text-dark"><%= jobOrder.getResume().getFullName()%>
                                    </a>
                                    </h4>
                                    <%
                                        }
                                    ...
                                    <h6 class="mt-4"><%= jobOrder.getEvaluateCompletion().getContent()%>
                                    </h6>
                                ...
                                <div class="job-list-button-sm text-right">
                                    <div class="mt-3">
                                        <a href="${pageContext.request.contextPath}/MainController?action=SearchJobID&searchJobID=<%= jobOrder.getJob().getJobID()%>"
                                           class="btn btn-sm btn-primary">View Detail Job</a>
                                    </div>
                                </div>
                            </div>
                        </div>
