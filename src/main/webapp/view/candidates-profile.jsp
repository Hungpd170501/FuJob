        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="candidates-profile-details text-center">
                    ...
                    <h5 class="text-white mb-2"><%=resume.getFullName()%>
                    </h5>
                    <p class="text-white-50 h6 mb-2"><%=resume.getMajor()%>
                    </p>
                ...
                <div class="border rounded p-4">
                    ...
                    <ul class="list-inline pt-3 border-top mb-0 row mt-4">
                        <li class="list-inline-item mr-3 col-md-6">
                            <p href="" class="text-muted f-15 mb-0 "><i
                                    class="mdi mdi-map-marker mr-2"></i>Address: ${requestScope.RESUME.address}</p>
                        </li>
                        <li class="list-inline-item mr-3 col-md-3">
                            <p href="" class="text-muted f-15 mb-0"><i
                                    class="mdi mdi-email mr-2">Email: </i>${requestScope.RESUME.gmail}</p>
                        </li>

                        <li class="list-inline-item mr-3 col-md-6">
                            <p href="" class="text-muted f-15 mb-0"><i
                                    class="mdi mdi-cellphone-iphone mr-2"></i>Phone: ${requestScope.RESUME.phone}</p>
                        </li>
                        <li class="list-inline-item mr-3 col-md-3">
                            <p href="" class="text-muted f-15 mb-0 "><i
                                    class="mdi mdi-timetable mr-2"></i>Joined ${requestScope.RESUME.createdDate}</p>
                        </li>
                    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-4 pt-5">
                        <div class="border rounded candidates-profile-education text-center text-muted">
                            ...
                            <h6 class="text-uppercase f-17 text-muted font-weight-bold " style="letter-spacing: 5px">
                                FPT UNIVERSITY</h6>
