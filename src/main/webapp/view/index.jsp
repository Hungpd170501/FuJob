                                        ...
                                        <div class="list-grid-item rounded">
                                            <div class="grid-item-content p-3 bg-light">
                                                ...
                                                <div class="grid-list-desc mt-3">
                                                    <h5 class="mb-1"><a href="${pageContext.request.contextPath}/MainController?action=SearchJobID&searchJobID=${t10.jobID}" class="text-dark">${t10.jobTitle}</a></h5>
                                                    <p class="text-muted f-14 mb-1">${t10.address}<br></p>
                                                    <p class="text-muted mb-1">${t10.salary} / hour</p>
                                                    <p class="text-muted mb-1">6 days left</p>
                                                </div>
                                            </div>
