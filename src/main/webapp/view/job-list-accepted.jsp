                ...
                <div id="chuaNameJob" class="row">
                    ...
                    >
                        ...
                        <li style="list-style: none">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-6 col-md-9">
                                                <div class="job-list-desc">
                                                    <h4 class="mb-2"><a
                                                        ...
                                                        <i class="painting-author"
                                                           style="font-style: normal;font-size: 20px ; font-weight: bold; color: orange">Pending
                                                            Review</i>
                                                        <%
                                                        } else if (jobOrder.getJobApplicationStatus() == 9) {
                                                        %>
                                                        <br>
                                                        <i class="mdi mdi-close-box mt-4"
                                                           style="font-size: 25px; color: red"></i>
                                                        <i class="painting-author"
                                                           style="font-style: normal;font-size: 20px ; font-weight: bold; color: red">Submission
                                                            Rejected</i>
                                                        <%
                                                            }
                                                        %>
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="job-list-button-sm text-right">
                                                    ...
                                                    <div class="mt-3">
                                                        <button onclick="getJobApplicatonID(<%= jobOrder.getJobApplicationID()%>)"
                                                                class="btn btn-sm btn-primary-outline"
                                                                data-toggle="modal" data-target="#SubmitProject"
                                                                style="width: 50%">Submit Project
                                                        </button>
                                                    </div>
                                                    <div class="mt-3">
                                                    ...
                                                    <div class="mt-3">
                                                        <button onclick="editJob('<%= jobOrder.getSubmitJob().getJobFile()%>', '<%= jobOrder.getSubmitJob().getMessageSubmit()%>', '<%= jobOrder.getJobApplicationID()%>')"
                                                                class="btn btn-sm btn-primary-outline"
                                                                data-toggle="modal" data-target="#EditSubmission"
                                                                style="width: 50%">Edit Submission
                                                        </button>
                                                    </div>
                                                    <div class="mt-3">
                                                        <button onclick="getFeedBack('<%= jobOrder.getReasonRejectionSubmmit()%>')"
                                                                class="btn btn-sm btn-primary-outline"
                                                                data-toggle="modal" data-target="#viewFeedBack"
                                                                style="width: 50%">View Feedback
                                                        </button>
                                                    </div>
                                                    <div class="mt-3">
                                                        <button onclick="getJobApplicatonIDtoDispute(<%= jobOrder.getJobApplicationID()%>)"
                                                    ...
                                                    <div class="mt-3">
                                                        <button onclick="getSubmitJob('<%= jobOrder.getSubmitJob().getJobFile()%>', '<%= jobOrder.getSubmitJob().getMessageSubmit()%>')"
                                                                class="btn btn-sm btn-primary-outline"
                                                                data-toggle="modal" data-target="#ViewSubmission"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-primary" id="exampleModalLongTitle">Do you want
                                                to cancel your application?</h5>
                                ...
                                <div class="modal-dialog modal-dialog-centered " role="document">
                                    <div class="modal-content">
                                        <div class="modal-header border-bottom-0 bg-warning">
                                            <h5 class="modal-title text-white" id="exampleModalLabel">Application
                                                Form</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group text-dark">
                                                ...
                                                <div style="height: 100px" class="form-control overflow-auto"><p
                                                        disabled="" id="msg"></p></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="SubmitProject" tabindex="-1" role="dialog"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header border-bottom-0">
                                            <h5 class="modal-title text-primary" id="exampleModalLabel">Submit
                                                Project</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <form method="post" action="${pageContext.request.contextPath}/MainController"
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group text-dark">
                                                    ...
                                                    <textarea class="form-control" required="" name="messageSubmit"
                                            ...
                                            <div class="modal-footer border-top-0 d-flex justify-content-center">
                                                ...
                                                <input type="hidden" class="btn btn-primary" name="action"
                                                       value="SendProject">
                                            </div>
                            ...
                            <div class="modal fade" id="ViewSubmission" tabindex="-1" role="dialog"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered " role="document">
                                    <div class="modal-content">
                                        <div class="modal-header border-bottom-0 bg-warning">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-6 form-group text-dark">
                                                    <a class="" target="_blank" rel="noopener noreferrer" type="text"
                                                       id="jobFile" href=""><p style="text-decoration: underline"><i
                                                        ...
                                                        <div class="w-100">
                                                            <div class="form-group text-dark">
                                                                ...
                                                                <div style="height: 100px"
                                                                     class="form-control overflow-auto"><p disabled=""
                                                                                                           id="contentFeedback"></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="modal fade" id="EditSubmission" tabindex="-1" role="dialog"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header border-bottom-0">
                                            <h5 class="modal-title text-primary" id="exampleModalLabel">Edit
                                                Project</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <form method="post" action="${pageContext.request.contextPath}/MainController"
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group text-dark">
                                                    <label>Message<span class="text-danger">*</span></label>
                                                    <textarea class="form-control" id="messageEditSubmit" required=""
                                                              name="messageEditSubmit"
                                                              placeholder="Message for employer"></textarea>
                                                </div>
                                                <div class="col-6 form-group text-dark">
                                                    <a class="" target="_blank" rel="noopener noreferrer" type="text"
                                                       id="fileEditProject" href=""><p
                                                            style="text-decoration: underline"><i
                                                            class="mdi mdi-link-variant"></i> Submitted file </p></a>
                                                </div>
                                                <div class="form-group text-dark">
                                                    <label>Upload new File</label>
                                                    <input type="file" class="form-control" name="fileEditProject"
                                                           required="">
                                                </div>
                                            </div>
                                            <div class="modal-footer border-top-0 d-flex justify-content-center">
                                            ...
                                            <input type="hidden" id="jobApplicationIDEdit" name="jobApplicationID"
                                                   value="">
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="Dispute" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header border-bottom-0">
                                            <h5 class="modal-title text-primary" id="exampleModalLabel">Dispute
                                                Form</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <form method="post" action="${pageContext.request.contextPath}/MainController">
                                            <div class="modal-body">
                                                <div class="form-group text-dark">
                                                    ...
                                                    <input id="titleDispute" type="text" required=""
                                                           class="form-control" name="titleDispute"
                                                           placeholder="Enter the title...">
                                                </div>
                                                <div class="form-group text-dark ckarea">
                                                    <label>Message<span class="text-danger">*</span></label>
                                                    <textarea id="messageDispute" class="form-control"
                                                              name="messageDispute" placeholder="Message for employer"
                                                              required></textarea>
                                                </div>
                                                <div class="form-group text-dark ckarea">
                                                    <label class="text-warning font-italic">This message will be sent to
                                                        the owner of this project!</label>
                                                </div>
                                            </div>
                                            <div class="modal-footer border-top-0 d-flex justify-content-center">
                                                <input type="submit" class="btn btn-primary" value="Send">
