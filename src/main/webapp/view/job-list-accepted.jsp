                                ...
                                <li style="list-style: none">
                                    <div class="job-display col-lg-12 mt-4 pt-2">
                                        <div class="job-list-box border rounded">
                                            <div class="p-3" style="width: 1100px ; height: 284px">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-3">
                                                    ...
                                                    <div class="col-lg-6 col-md-9">
                                                        <div class="job-list-desc">
                                                            <h4 class="mb-2">
                                                                <a  class="text-dark" href="${pageContext.request.contextPath}/MainController?action=SearchJobID&searchJobID=<%= jobOrder.getJob().getJobID()%>"><%= jobOrder.getJob().getJobTitle()%>
                                                                    ...
                                                                    <i class="painting-author" style="font-style: normal;font-size: 20px ; font-weight: bold; color: red">Not Completed</i>
                                                                    <%
