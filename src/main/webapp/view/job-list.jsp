            ...
            <div class="col-lg-12">
                <div class="show-results">
                    <div class="registration-form-box float-right">
                        <button class="btn btn-sm btn-primary-outline" onclick="sortList('painting-bid', 'desc')">
                            Highest bid first
                        </button>
                        ...
                        <button class="btn btn-sm btn-primary-outline" onclick="sortList('painting-id', 'desc')"> Newest
                            project first
                        </button>
                        <button class="btn btn-sm btn-primary-outline" onclick="sortList('painting-id', 'asc')"> Oldest
                            project first
                        </button>
                    </div>
                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-9">
                                        <div class="job-list-desc">
                                            <h4 class="painting-name mb-1" style="font-weight: 700"><a
                                                    ...
                                                    class="text-dark mb-5"><%= job.getJobTitle()%>
                                            </a></h4>
                                            <%
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="job-list-button-sm text-right">
                                            <div>
                                                <h6 class="painting-bid mb-1"><i class="mr-2"></i><%= job.getBids()%>
                                                    bid(s)</h6>
                                            </div>
