...
<html lang="en" class="no-js">
    <head>
        <jsp:useBean id ="job" class="se1621.dao.JobDAO" scope="request"></jsp:useBean>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-7 col-md-9">
                                                    <div class="job-list-desc">
                                                        <h6 class="mb-2"><a href="#" class="text-dark">${i.jobTitle}</a></h6>
                                                        <p class="text-muted mb-0"><i class="mdi mdi-bank mr-2"></i>${i.email}</p>
                                                        <ul class="list-inline mb-0">
                                                            ...
                                                            <li class="list-inline-item">
                                                                <p class="text-muted mb-0"><i class="mdi mdi-clock-outline mr-2"></i>${i.deadline}</p>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <p class="text-muted mb-0"><i class="mdi mdi-clock-outline mr-2"></i>${i.completionTime}</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
