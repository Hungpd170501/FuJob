            ...
            <div class="col-lg-12 mt-4 pt-2">
                ...
                <div class="row">
                    ...
                    >
                                            ...
                                            <div class="col-lg-5 col-md-9">
                                                <div class="job-list-desc">
                                                    <h4 class="mb-2"><a
                                                        ...
                                                        <i class="painting-author"
                                                           style="font-style: normal;font-size: 20px ; font-weight: bold; color: green">In
                                                            Progress</i>
                                                        <%
                                                        ...
                                                        <i class="painting-author"
                                                           style="font-style: normal;font-size: 20px ; font-weight: bold; color: orange">Need
                                                            To Review</i>
                                                        <%
                                                            }
                                                        %>
                                            ...
                                            <div class="col-lg-4 col-md-3">
                                                <div class="job-list-button-sm text-right">
                                                    ...
                                                    <div class="candidates-listing-btn mt-4">
                                                        <a href="${pageContext.request.contextPath}/MainController?action=SearchResumeID&studentID=<%= jobOrder.getResume().getUserID()%>"
                                                           class="btn btn-primary-outline btn-sm " style="width: 50%">Student
                                                            Profile</a>
                                                    </div>
                                                    <!--                                                            <div class="mt-3">
                                                    ...
                                                    <div class="mt-3">
                                                        <button onclick="endProject(<%= jobOrder.getJob().getJobID()%>, <%= jobOrder.getJob().getUserID()%>, <%= jobOrder.getJobApplicationID()%>,<%= jobOrder.getResumeID()%>)"
                                                                type="button" class="btn btn-primary-outline-red btn-sm"
                                                                data-toggle="modal" data-target="#formEndProject"
                                                                style="width: 50%">
                                                            End Project
                                                        </button>
                                                    </div>
                                                    <div class="mt-3">
                                                        <button onclick="getJobApplicatonIDtoDispute(<%= jobOrder.getJobApplicationID()%>)"
                                                                class="btn btn-sm btn-danger-outline"
                                                                data-toggle="modal" data-target="#Dispute"
                                                                style="width: 50%">Dispute
                                                        </button>
                                                    </div>
                                                    <%
                                                    } else if (jobOrder.getJob().getJobStatus() == 8) {
                                                    ...
                                                    <div class="mt-3">
                                                        <button onclick="getSubmitProductjobFile('<%= jobOrder.getSubmitJob().getJobFile()%>', '<%= jobOrder.getSubmitJob().getMessageSubmit()%>', '<%= jobOrder.getJobApplicationID()%>', '<%= jobOrder.getJob().getJobID()%>', '<%= jobOrder.getJob().getUserID()%>', '<%= jobOrder.getResumeID()%>')"
                                                                type="button" class="btn btn-sm btn-primary-outline"
                                                                data-toggle="modal"
                                                                data-target="#ViewProductSubmissionForm"
                        ...
                        <div class="modal fade" id="ViewformApplication" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6 form-group text-dark">
                                                <a class="" target="_blank" rel="noopener noreferrer" type="text"
                                                   id="CV" href=""><p id="CVp" style="text-decoration: underline"><i
                                                        class="mdi mdi-link-variant"></i> View CV </p></a>
                                            </div>
                                        </div>
                                        <div class="form-group text-dark">
                                            <label style="font-size: 16px">Message: </label>
                                            <div style="height: 100px" class="form-control overflow-auto"><p disabled=""
                                                                                                             id="msg"></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/MainController">
                                        <div class="modal-body">
                                            <div class="form-group text-dark">
                                                ...
                                                <input id="titleDispute" type="text" required="" class="form-control"
                                                       name="titleDispute" placeholder="Enter the title...">
                                            </div>
                                            <div class="form-group text-dark ckarea">
                                                <label>Message<span class="text-danger">*</span></label>
                                                <textarea id="messageDispute" class="form-control" name="messageDispute"
                                                          placeholder="Message for employer" required></textarea>
                                            </div>
                                            <div class="form-group text-dark ckarea">
                                                <label class="text-warning font-italic">This message will be sent to the
                                                    freelancer of this project!</label>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" id="jobApplicationIDDispute" name="jobApplicationID"
                                               value="">
                                        <input type="hidden" name="studentID" value="${sessionScope.LOGIN_USER.userID}">
                                    </form>
                                </div>
                        ...
                        <div class="modal fade" id="ViewProductSubmissionForm" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered " role="document">
                                <div class="modal-content">
                                    <div class="modal-header border-bottom-0 bg-warning">
                                        <h5 class="modal-title text-white" id="exampleModalLabel">Product Submission
                                            Form</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-12 form-group text-dark">
                                                <a class="" target="_blank" rel="noopener noreferrer" type="text"
                                                   id="product" href=""><p style="text-decoration: underline"><i
                                                        class="mdi mdi-link-variant"></i> View Product </p></a>
                                            </div>
                                        </div>
                                        <div class="form-group text-dark">
                                            <label style="font-size: 16px">Message: </label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="hidden" id="jobApplicationID_FromEndJob" name="jobApplicationID"
                                               value="">
                                        <button onclick="setZIndex()" id="YesShowForm1" type="button"
                                        ...
                                        <button onclick="setZIndex()" id="YesShowForm2" type="button"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-primary" id="exampleModalLongTitle">This Project
                                                Is Not
                                                Complete?</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <div class="d-flex flex-start w-100">
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <div class="form-outline">
                                                                <label class="form-label" for="textAreaExample">Could
                                                                    you tell us what when wrong?</label>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="hidden" id="unCompleteJob_jobApplicationID"
                                                   name="jobApplicationID" value="">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="hidden" id="rejectJob_jobApplicationID" name="jobApplicationID"
                                                   value="">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/MainController">
                            <div class="modal fade" id="confirmAcceptaction" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-primary" id="exampleModalLongTitle2">This
                                                Project Is
                                                Completed?</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <div class="d-flex flex-start w-100">
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <div class="rating">
                                                                ...
                                                                <label for="5" class="rate">☆
                                                                    <div class="face face-5"></div>
                                                                </label>
                                                                <input type="radio" name="rating" value="4" id="4">
                                                                <label for="4" class="rate">☆
                                                                    <div class="face face-4"></div>
                                                                </label>
                                                                <input type="radio" name="rating" value="3" id="3">
                                                                <label for="3" class="rate">☆
                                                                    <div class="face face-3"></div>
                                                                </label>
                                                                <input type="radio" name="rating" value="2" id="2">
                                                                <label for="2" class="rate">☆
                                                                    <div class="face face-2"></div>
                                                                </label>
                                                                <input type="radio" name="rating" value="1" id="1">
                                                                <label for="1" class="rate">☆
                                                                    <div class="face face-1"></div>
                                                                </label>
                                                            </div>
                                                            <div class="form-outline">
                                                                <label class="form-label" for="textAreaExample2">What's
                                                                    your view?</label>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="hidden" id="completeJob_jobApplicationID"
                                    ...
                                    <div class="modal-content">
                                                    ...
                                                    <div class="d-flex flex-start w-100">
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <div class="" style="display: flex">
                                                                <input onchange="showButton()" type="radio"
                                                                       id="DeleteJob" name="chooseOption"
                                                                       value="DeleteJob" class="mr-3" checked="checked">
                                                                <label>My requirements have changed and I no longer
                                                                    required this work to be done</label>
                                                            </div>
                                                            <div class="">
                                                                <input onchange="showButton()" type="radio"
                                                                       id="FreelancerInComplete" name="chooseOption"
                                                                       value="FreelancerInComplete" class="mr-3">
                                                                <label>The freelancer is unable to complete my
                                                                    project</label>
                                                            </div>
                                                            <div class="">
                                                                <input onchange="showButton()" type="radio"
                                                                       id="FreelancerComplete" name="chooseOption"
                                                                       value="FreelancerComplete" class="mr-3">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="hidden" name="action"
                                                   value="DeleteJobBecauseChangeRequirement">
                                            <input type="hidden" id="jobPostID_FromEndJob" name="jobPostID" value="">
                                            <input type="hidden" id="userID_FromEndJob" name="userID" value="">
                                            <input type="hidden" id="jobApplicationID_FromEndJob"
                                                   name="jobApplicationID" value="">
                                            <input id="YesDeleteJob" type="submit" value="End Project"
                                                   class="btn btn-primary">

                                            <button onclick="setZIndex()" id="YesShowForm12" type="button"
                                                    class="btn btn-primary"
                                                    class="close" data-dismiss="modal" aria-label="Close"
                                                    data-toggle="modal" data-target="#confirmCancellation"
                                                    style="display: none">
                                                End Project
                                            </button>
                                            <button onclick="setZIndex()" id="YesShowForm13" type="button"
                                                    class="btn btn-primary"
                                                    class="close" data-dismiss="modal" aria-label="Close"
                                                    data-toggle="modal" data-target="#confirmAcceptaction"
                                                    style="display: none">
                        ...
                        <div class="modal fade" id="formApplication" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header border-bottom-0">
                                        <h5 class="modal-title text-primary" id="exampleModalLabel">Application
                                            Form</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <form onSubmit="return validate();" method="post"
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group text-dark">
                                                ...
                                                <input id="deal" type="number" step="0.5" required=""
                                                       class="form-control" name="salaryDeal"
                                            ...
                                            <div class="row form-group text-dark">
                                                <div class="col-6">
                                                    <input onchange="showUpload()" type="radio" id="cvDefault"
                                                           name="chooseCV" value="CVdefault">
                                                    <label>CV Default (Your Resume)</label>
                                                </div>
                                                <div class="col-6">
                                                    <input onchange="showUpload()" type="radio" id="upCv"
                                                           name="chooseCV" value="upCv">
