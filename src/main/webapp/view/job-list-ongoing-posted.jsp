                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 form-group text-dark">
                                                        <%if (jobOrder.getCvFile() == null) {
                                                        %>
                                                        <a class="" style="display: none"  target="_blank" rel="noopener noreferrer" type="text" id="CV" href="" ><p style="text-decoration: underline"> <i class="mdi mdi-link-variant"></i> View CV </p></a>
                                                        <%
                                                        } else {
                                                        %>
...
>>>>>>> 2f67a7f7344fb6d707124ae4a280be32018179ee
                                            </div>
