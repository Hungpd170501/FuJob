...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <script>
            function completeJob(jobAppID, jobID) {
                $('#yesOption2').attr('href', '${pageContext.request.contextPath}/MainController?action=CompleteJob&jobAppID=' + jobAppID + '&jobID=' + jobID);
            }
        </script>
