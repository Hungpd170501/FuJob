                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6 form-group text-dark">
                                                <%if (jobAplication.getCvFile() == null) {
                                                %>
                                                <a style="display: none" class="" target="_blank" rel="noopener noreferrer" type="text" id="CV" href="" ><p style="text-decoration: underline"> <i class="mdi mdi-link-variant"></i> View CV </p></a>
                                                <%
                                                } else {
                                                %>
