            ...
            <div class="col-lg-12 mt-4 pt-2">
                            ...
                            <div class="row">
                                <div class="col-md-9 ">
                                    <div class="float-left mr-4">
                                        <img src="<%= jobAplication.getResume().getAvatar()%>" alt=""
                                             class="img-fluid d-block rounded" height="50"
                                             style="width:220px;height:240px">
                                    </div>
                                    <div class="candidates-list-desc overflow-hidden job-single-meta  pt-2 p-3">
                                        <h4 class="mb-3"><a
                                                class="text-dark"><%= jobAplication.getResume().getFullName()%>
                                        </a></h4>
                                        <p class=" mb-3">
                                            <h7 style="font-weight: 700"> Gender:</h7>
                                            <%= jobAplication.getResume().getGender()%>
                                        </p>
                                        <p class=" mb-3">
                                            <h7 style="font-weight: 700"> Gmail:</h7>
                                            <%= jobAplication.getResume().getGmail()%>
                                        </p>
                                        <p class=" mb-3">
                                            <h7 style="font-weight: 700"> Phone:</h7>
                                            <%= jobAplication.getResume().getPhone()%>
                                        </p>
                                        <p class=" mb-3">
                                            <h7 style="font-weight: 700">Skill:</h7>
                                            <%
                                ...
                                <div class="col-md-3">
                                    <div class="candidates-list-fav-btn text-right">
                                        <div class="candidates-listing-btn mt-4">
                                            <a href="${pageContext.request.contextPath}/MainController?action=SearchResumeID&studentID=<%= jobAplication.getResume().getUserID()%>"
                                               class="btn btn-primary-outline btn-sm " style="width: 50%">View
                                                Profile</a>
                                        </div>
                                        <div class="mt-3">
                                            <%
                                        ...
                                        <div class="mt-3">
                                            <a href="#"
                                               onclick="denyJobApp(<%= jobAplication.getResumeID()%>,<%= jobID%>)"
                                               class="btn btn-primary-outline-red btn-sm" data-toggle="modal"
                                               data-target="#formCancel" style="width: 50%">Deny</a>
                                        </div>
                                        <div class="mt-3">
                                            <button onclick="acceptJobApp(<%= jobAplication.getResumeID()%>,<%= jobID%>)"
                                        ...
                                        <div class="mt-3">
                                            <button onclick="getJobOrder('<%= jobAplication.getPriceDeal()%>', '<%= jobAplication.getMessage()%>', '<%= jobAplication.getCvFile()%>')"
                                                    class="btn btn-sm btn-primary-outline" data-toggle="modal"
                                                    data-target="#ViewformApplication" style="width: 50%">Application
                                                Form
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group text-dark">
                                        <a class="" target="_blank" rel="noopener noreferrer" type="text" id="CV"
                                           href=""><p id="CVp" style="text-decoration: underline"><i
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-primary" id="exampleModalLongTitle">Do you want to deny this
                                    application?</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                ...
                <div class="modal fade" id="confirmAcceptaction" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-primary" id="exampleModalLongTitle">Do you want to accept
                                    this application?</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <form method="post" action="" enctype="multipart/form-data" id="formRejection">
                                <div class="modal-body">
                                    <div class="form-group text-dark">
                                        ...
                                        <textarea class="form-control" name="reasonCancel" id="reasonCancel"
                                                  placeholder="Reason you reject this application"></textarea>
                                    </div>
                                </div>
