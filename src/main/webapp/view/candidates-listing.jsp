                                        ...
                                        <div class="col-md-3">
                                            <div class="candidates-list-fav-btn text-right">        
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    %>
                                                    <button onclick="denyJobApp(<%= jobAplication.getResume().getResumeID()%>,<%= jobID%>)" type="button" class="btn btn-primary-outline-red btn-sm" data-toggle="modal" data-target="#confirmCancellation" style="width: 50%">
                                                        Deny
                                                    </button>
                                                </div>
                                                <div class="mt-3">

                                                    <button onclick="acceptJobApp(<%= jobAplication.getResume().getResumeID()%>,<%= jobID%>)" type="button" class="btn btn-primary-outline btn-sm" data-toggle="modal" data-target="#confirmAcceptaction" style="width: 50%">
                                                        Accept
                                                    </button>
                                                </div>
                                                <div class="mt-3">
