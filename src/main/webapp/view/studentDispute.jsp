            ...
            <div class="col-lg-12 mt-4 pt-2">
                ...
                <div id="chuaNameJob" class="row">
                    ...
                    <li style="list-style: none">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-3">
                                            <div class="company-logo-img">
                                                <img src="<%= dispute.getJobApplication().getJob().getCategory().getImg()%>"
                                        ...
                                        <div class="col-lg-6 col-md-9">
                                            <div class="job-list-desc">
                                                <h4 class="mb-2"><a
                                                        href="${pageContext.request.contextPath}/MainController?action=SearchJobID&searchJobID=<%= dispute.getJobApplication().getJob().getJobID()%>"
                                                        class="text-dark"><%= dispute.getJobApplication().getJob().getJobTitle()%>
                                                    <br>
                                                    <i class="mdi mdi-bookmark-check mt-4"
                                                       style="font-size: 25px; color: orange"></i>
                                                    <i class="painting-author"
                                                       style="font-style: normal;font-size: 20px ; font-weight: bold; color: orange">In
                                                        Dispute</i>
                                                </a>
                                                </h4>
                                                ...
                                                <h6>
                                                    <%= dispute.getJobApplication().getJob().getPayMentMethod().getPaymentMethodName()%>
                                                    : <%= dispute.getJobApplication().getJob().getMinBudget()%>$
                                                    - <%= dispute.getJobApplication().getJob().getMaxBudget()%>
                                                    $ <% if (dispute.getJobApplication().getJob().getPayMentMethod().getPaymentMethodID() == 2) {
                                                %>
                                                    / hour
                                                    <%
                                                        }
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="job-list-button-sm text-right">
                                                ...
                                                %>
                                                <div class="mt-3">
                                                    <button onclick="viewEvidence('<%= dispute.getEvidence().getMessage()%>', '<%= dispute.getEvidence().getEvidenceFile()%>')"
                                                            class="btn btn-sm btn-primary-outline" data-toggle="modal"
                                                            data-target="#viewEvidence" style="width: 50%">View Evidence
                                                    </button>
                                                </div>
                                                <%
                                                } else {
                                                %>
                                                <div class="mt-3">
                                                    <button onclick="getDisputeI(<%= dispute.getDisputeID()%>)"
                                                            class="btn btn-sm btn-primary-outline" data-toggle="modal"
                                                            data-target="#sendEvidence" style="width: 50%">Send Evidence
                                                    </button>
                                                </div>
                                                <%
                                                    }
                                                ...
                                                <br>
                                                <div class="mt-3">
                                                    <button onclick="getDisputeID(<%= dispute.getDisputeID()%>)"
                                                            class="btn btn-sm btn-danger-outline" data-toggle="modal"
                                                            data-target="#CancelDispute" style="width: 50%">Cancel
                                                    </button>
                                                </div>
                                                <%
                                                    }
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="CancelDispute" tabindex="-1" role="dialog"
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/MainController">
                                        <div class="modal-body">
                                            <div class="form-group text-dark ckarea">
                                                ...
                                                <textarea id="messageCancelDispute" class="form-control"
                                                          name="messageCancelDispute" placeholder="Message for employer"
                                                          required></textarea>
                                            </div>
                                            <div class="form-group text-dark ckarea">
                                                <label class="text-warning font-italic">This message will be sent to the
                                                    owner of this project!</label>
                                            </div>
                                        </div>
                        ...
                        <div class="modal fade" id="sendEvidence" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header border-bottom-0">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/MainController"
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group text-dark ckarea">
                                                ...
                                                <textarea id="userStory" class="form-control" name="userStory"
                                                          placeholder="Tell us your story..." required></textarea>
                                            </div>
                        ...
                        <div class="modal fade" id="viewEvidence" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered " role="document">
                                <div class="modal-content">
                                    <div class="modal-header border-bottom-0 bg-warning">
                                        <h5 class="modal-title text-white" id="exampleModalLabel">Your Sent
                                            Evidence</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                        ...
                                        <div class="row">
                                            <div class="col-6 form-group text-dark">
                                                <a class="" target="_blank" rel="noopener noreferrer" type="text"
                                                   id="evidenceFile" href=""><p style="text-decoration: underline"><i
                                                        class="mdi mdi-link-variant"></i> View Evidence You Sent</p></a>
                                            </div>
                                        </div>
                                        <div class="form-group text-dark">
