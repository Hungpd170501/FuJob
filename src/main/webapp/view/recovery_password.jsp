...
<div class="back-to-home rounded d-none d-sm-block">
    <a href="${pageContext.request.contextPath}/view/index.jsp" class="text-white rounded d-inline-block text-center"><i
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="alert shadow alert-light hide-if-empty text-center"
                             role="alert">${requestScope.RECOVERY_PASSWORD_MESSAGE}</div>
                        <div class="login_page bg-white shadow rounded p-4">
                            ...
                            <form class="login-form" id="recovery-pasword-form" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <p class="text-muted">Enter your user account's verified email address and we
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <button class="btn btn-primary w-100" type="submit"
                                                form="recovery-pasword-form">Send password reset email
                                        </button>
                                    </div>
                                </div>
                            </form>
