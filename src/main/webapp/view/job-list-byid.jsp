        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="section-title text-center mb-4 pb-2">
                    ...
                    %>
                    <h4 class="title title-line pb-5">Projects were posted by <%= hr.getFullName()%>
                    </h4>
                    <%
                    } else {
                    %>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-6 col-md-9">
                                                <div class="job-list-desc">
                                                    <h4 class="mb-1" style="font-weight: 700"><a
                                                        ...
                                                        <i class="painting-author"
                                                           style="font-style: normal;font-size: 20px ; font-weight: bold; color: green">Open</i>
                                                        <%
                                                            }
                                                        %>
                                                    </a>
                                                    ...
                                                    <h6>
                                                        ...
                                                        : <%= job.getMinBudget()%>$ - <%= job.getMaxBudget()%>
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="job-list-button-sm text-right">
                                                    ...
                                                    <br>
                                                    <div class="mt-3">
                                                        <a href="${pageContext.request.contextPath}/MainController?action=EditJob&jobID=<%= job.getJobID()%>"
                                                           class="btn btn-sm btn-primary-outline" style="width: 50%">Edit
                                                            Project</a>
                                                    </div>
                                                    <div class="mt-3">
                                                    ...
                                                    <div class="mt-3">
                                                        <a onclick="getJobPostID(<%=job.getJobID()%>, <%= job.getUserID()%>)"
                                                           href="#" class="btn btn-primary-outline-red btn-sm"
                                                           data-toggle="modal" data-target="#formCancel"
                                                           style="width: 50%">Delete</a>
                                                    </div>

                                                    <div class="mt-3">

                                                        <a href="${pageContext.request.contextPath}/MainController?action=SearchCandidateOfJob&JobIDCandidate=<%= job.getJobID()%>"
                                                           class="btn btn-sm btn-primary-outline" style="width: 50%">List
                                                            candidate</a>
                                                    </div>
                                                    <%
                                                        }
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group text-dark">
                                                ...
                                                <textarea class="form-control" name="reasonCancel" id="reasonCancel"
                                                          placeholder="Reason you cancel this project"></textarea>
                                            </div>
                                        </div>
