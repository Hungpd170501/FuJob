                                            ...
                                            <div class="col-lg-6 col-md-9">
                                                <div class="job-list-desc">
                                                    <h4 class="mb-1" style="font-weight: 700"><a
                                                            ...
                                                            %>
                                                            <span>
                                                                <i class="mdi mdi-bookmark-check mt-4" style="font-size: 20px; font-style: normal; color: green">Open</i> 
                                                            </span>
                                                            <!--<i style="font-style: normal;font-size: 20px ; font-weight: bold; color: green">Open</i>-->
                                                            <%
                                                            } else if (job.getJobStatus() == 4) {
                                                            %>
                                                            <span>
                                                                <i class="mdi mdi-bookmark-check mt-4" style="font-size: 20px;font-style: normal; color: grey">Overdue</i>                                                                 
                                                            </span>
                                                            <!--<i style="font-style: normal;font-size: 20px ; font-weight: bold; color: grey">Overdue</i>-->
                                                            <%
                                                                }
                                                            %>
                                                        </a></h4>
                                                ...
                                                <div class="job-list-button-sm text-right">
                                                    ...
                                                    <div class="mt-3">
                                                        <a href="${pageContext.request.contextPath}/MainController?action=SearchJobID&searchJobID=<%= job.getJobID()%>"
                                                           class="btn btn-sm btn-primary" style="width: 50%">View Detail</a>
                                                    </div>
                                                    <div class="mt-3">

                                                        <button onclick="getJobPostID(<%= job.getJobID()%>, <%= job.getUserID()%>)"
                                                                type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                                data-target="#confirmCancellation" style="width: 50%">
                                                            Cancel
                                                        </button>
                                                    ...
                                                    <div class="mt-3">
                                                        <a href="${pageContext.request.contextPath}/MainController?action=SearchCandidateOfJob&JobIDCandidate=<%= job.getJobID()%>"
                                                           class="btn btn-sm btn-primary" style="width: 50%">List candidate</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
