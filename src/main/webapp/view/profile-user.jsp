            ...
            <div class="col-md-6">
                <div class="text-center text-white">
                    <ul class="page-next d-inline-block mb-0">
                        <li><a href="${pageContext.request.contextPath}/view/index.jsp"
                               class="text-uppercase font-weight-bold">Home</a></li>
                        <li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6 mx-auto form-group position-relative">
                    ...
                    <div class="row">
                        <span class="col-md-2 form-control text-center"><i
                                class="mdi mdi-24px mdi-account-card-details"></i></span>
                        <input type="text" name="fullName" class="form-control col-md-10"
                ...
                <div class="col-md-6 mx-auto form-group position-relative">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control col-md-10" value="${sessionScope.LOGIN_USER.email}"
                               readonly="">
                    </div>
                </div>
                <%
                ...
                %>
                <div class="col-md-6 mx-auto"><a href="#" data-toggle="modal" data-target="#formPassword"><i
                        class="mdi mdi-key mr-1"></i><u>Change Password</u></a></div>
                <%
                    }
                %>
                <input type="hidden" name="userID" value="${sessionScope.LOGIN_USER.userID}">
                <div class="mt-5 text-center"><input class="btn btn-primary profile-button" name="action" type="submit"
...
<div class="modal fade" id="formPassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
            ...
            <form method="post" action="${pageContext.request.contextPath}/MainController">
                <div class="modal-body">
                    <div class="form-group text-dark">
                        ...
                        <input id="passwordEnter" type="password" class="form-control" name="passwordEnter"
