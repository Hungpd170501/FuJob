                                ...
                                <div class="col-md-12">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <input id="jobtitle" name="jobTitle" type="text" class="form-control resume"
                                               required="" value="${requestScope.JOB.jobTitle}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <div class="form-button p-1">
                                            <select id="cateID" class="form-control resume" name="categoryID"
                                                    required="">
                                                <%
                                                    if (job.getCategory() != null) {
                                                %>
                                                <option id="" selected="selected"
                                                        value="${requestScope.JOB.category.categoryID}">${requestScope.JOB.category.categoryName}</option>
                                                <%
                                                    }
                                                %>
                                        ...
                                        <div class="form-button p-1">
                                            <select class="form-control resume select2 select2-hidden-accessible"
                                                ...
                                                <option selected="selected"
                                                        value="<%= jobSkill.getSkill().getSkillID()%>"><%= jobSkill.getSkill().getSkillName()%>
                                                </option>
                                    ...
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <div class="row form-button">
                                            <div class="col-lg-6 p-1 col-md-6">
                                                <select id="paymentID" class="form-control resume"
                                                        name="paymentMethodID">
                                                    <%
                                                        if (job.getPayMentMethod() != null) {
                                                    %>
                                                    <option selected="selected"
                                                            value="${requestScope.JOB.payMentMethod.paymentMethodID}">${requestScope.JOB.payMentMethod.paymentMethodName}</option>
                                                    <%
                                                        }
                                                    %>
                                            ...
                                            <div class="col-lg-3 p-1 col-md-5">
                                                ...
                                                %>
                                                <input id="minBudget" name="minBudget" type="number" step="0.5"
                                                       min="0.5" class="form-control resume"
                                                       value="${requestScope.JOB.minBudget}" required=""
                                                       placeholder="0.5">
                                                <%
                                                } else {
                                                %>
                                                <input id="minBudget" name="minBudget" type="number" step="0.5"
                                                       min="0.5" class="form-control resume" value="" required=""
                                                       placeholder="0.5">
                                                <%
                                                    }
                                                %>
                                            ...
                                            <div class="col-lg-3 p-1 col-md-5">
                                                ...
                                                %>
                                                <input id="maxBudget" name="maxBudget" type="number" step="0.5" min="1"
                                                       class="form-control resume" value="${requestScope.JOB.maxBudget}"
                                                       required="" placeholder="10">
                                                <%
                                                } else {
                                                %>
                                                <input id="maxBudget" name="maxBudget" type="number" step="0.5" min="1"
                                                       class="form-control resume" value="" required=""
                                                       placeholder="10">
                                                <%
                                                    }
                                                %>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <input onchange="checkValidation()" id="email" name="email" type="email"
                                               class="form-control resume" required="" value="${requestScope.JOB.email}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <input onchange="checkValidation()" id="phone" name="phone" type="tel"
                                               class="form-control resume" value="${requestScope.JOB.phone}" required=""
                                ...
                                <div class="col-md-4">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <input min="<%=dtf.format(localDate)%>" id="expiriedDate" name="expiriedDate"
                                               type="date" class="form-control resume"
                                               value="${requestScope.JOB.expiriedDate}" required=""
                                ...
                                <div class="col-md-8">
                                    <div class="form-group app-label mt-2">
                                        ...
                                        <input id="address" name="address" type="text" class="form-control resume"
                                               required="" value="${requestScope.JOB.address}"
                                               placeholder="District 9, Ho Chi Minh City">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group app-label">
                                        ...
                                        <textarea id="description" name="description" type="text"
                                                  ...
                                                  placeholder="Things needed for the job:">${requestScope.JOB.description}</textarea>
                                    </div>
                                </div>
                            </div>
