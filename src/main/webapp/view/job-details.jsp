    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="row job-detail border rounded p-4 row">
                    ...
                    <div class="col-lg-7" style="margin-top: 30px">
                        <div class="job-detail-com-desc overflow-hidden d-block">
                            <p class=" mb-3">
                                <h7 style="font-weight: 700"> Date posted:</h7>
                                <%
                            ...
                            <p class=" mb-3">
                                ...
                                <% }%></p>
                            <p class=" mb-3">
                                <h7 style="font-weight: 700"> Payment Method:</h7>
            ...
            <div class="col-lg-4 col-md-5 mt-4 mt-sm-0">
                ...
                %>
                <div class="job-detail border rounded mt-4">
                    <a onclick="getBudget(<%=job.getMinBudget()%>, <%= job.getMaxBudget()%>)" href="#"
                       class="btn btn-primary btn-block" data-toggle="modal" data-target="#formApplication">Apply For
                        Project</a>
                </div>
                <%
                            }
        ...
        <div class="row" style="margin-top: 10px">
            <div class="col-lg-12">
                <div class="job-detail border rounded mt-2 p-4">
                    ...
                    <div>
                        <h5 class="text-dark" style="font-weight: 700"><%= messageEvaluation%>
                        </h5>
                    </div>
                    <%
                            ...
                            <div class="row">
                                <div class="col-md-9 ">
                                    <div class="float-left mr-4">
                                        <img src="<%= jobApp.getResume().getAvatar()%>" alt=""
                                             class="img-fluid d-block rounded" height="50"
                                             style="width:150px;height:150px">
                                    </div>
                                    <div class="candidates-list-desc overflow-hidden job-single-meta  pt-2 p-3">
                                        <h4 class="mb-3"><a class="text-dark"
                                                            href="${pageContext.request.contextPath}/MainController?action=SearchResumeID&studentID=<%= jobApp.getResume().getUserID()%>"><%= jobApp.getResume().getFullName()%>
                                        </a></h4>
                                        <p class=" mb-3">
                                            <h7 style="font-weight: 700"><%= jobApp.getMessage()%>
                                            </h7>
                                        </p>
                                        <p class=" mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="candidates-list-fav-btn text-right">
                                        <div class="candidates-listing-btn mt-4">
                                            <a href="${pageContext.request.contextPath}/MainController?action=SearchResumeID&studentID=<%= jobApp.getResume().getUserID()%>"
