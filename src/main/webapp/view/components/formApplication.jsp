...
<!DOCTYPE html>
<body>
<div class="modal fade" id="formApplication" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form onSubmit="return validate();" method="post" action="${pageContext.request.contextPath}/MainController"
                  enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group text-dark">
                        <label>Deal Price ($)<span class="text-danger">*</span></label>
                        <input id="deal" type="number" step="0.5" required="" class="form-control" name="salaryDeal"
                               placeholder="Enter price you want to deal">
                    </div>
                    <div class="form-group text-dark ckarea">
                        <label>Message<span class="text-danger">*</span></label>
                        <textarea id="message" class="form-control" name="message" placeholder="Message for employer"
                                  required></textarea>
                    </div>
                    <div class="row form-group text-dark">
                        <div class="col-6">
                            <input checked="checked" onchange="showUpload()" type="radio" id="cvDefault" name="chooseCV"
                                   value="CVdefault">
