            ...
            <div class="col-lg-12 mt-4 pt-2">
                ...
                <div class="row">
                    ...
                    >
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-6 col-md-9">
                                                <div class="job-list-desc">
                                                    <h4 class="mb-2"><a
                                                        ...
                                                        %>
                                                        <br>
                                                        <i class="mdi mdi-timelapse mt-4"
                                                           style="font-size: 25px; color: #C0C000"></i>
                                                        <i class="painting-author"
                                                           style="font-style: normal;font-size: 20px ; font-weight: bold; color: #C0C000">Waiting</i>
                                                        <%
                                                        ...
                                                        <i class="painting-author"
                                                           style="font-style: normal;font-size: 20px ; font-weight: bold; color: red">Application
                                                            Closed</i>
                                                        <%
                                                            }
                                                        %>
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="job-list-button-sm text-right">
                                                    ...
                                                    <div>
                                                        <p class=" "><i
                                                                class="mr-2"></i><%= jobOrder.getJob().getBids()%>
                                                            bid(s)</p>
                                                    </div>
                                                    <br>
                                                    <div class="mt-3">
                                                    ...
                                                    <div class="mt-3">
                                                        <a onclick="getJobOrderID(<%= jobOrder.getJobApplicationID()%>, <%= jobOrder.getResumeID()%>)"
                                                           href="#" class="btn btn-primary-outline-red btn-sm"
                                                           data-toggle="modal" data-target="#formUnapply"
                                                           style="width: 50%">Retract</a>
                                                    </div>
                                                    <%
                                                    } else if (jobOrder.getJobApplicationStatus() == 5) {
                                                    %>
                                                    ...
                                                    <div class="mt-3">
                                                        <button onclick="getRejectionFrm('<%= jobOrder.getReasonRejection()%>')"
                                                                class="btn btn-sm btn-primary-outline"
                                                                data-toggle="modal" data-target="#ViewFormRejection"
                                                                style="width: 50%">View Rejection Form
                                                        </button>
                                                    </div>
                        ...
                        <div class="modal fade" id="formUnapply" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header border-bottom-0">
                                        <h5 class="modal-title text-primary" id="exampleModalLabel">Cancellation
                                            Form</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <form id="formUnapplyToSendhref" method="post" action=""
                                          enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <div class="form-group text-dark">
                                                <label>Your Reason<span class="text-danger">*</span></label>
                                                <textarea class="form-control" name="reasonUnaplly" id="reasonUnaplly"
                                                          placeholder="Reason you cancel your application"></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="modal fade" id="ViewFormRejection" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered " role="document">
                                <div class="modal-content">
                                    <div class="modal-header border-bottom-0 bg-warning">
