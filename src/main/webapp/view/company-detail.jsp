                ...
                <div class="text-sm-center">
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item">
                            <a href="#" class="text-danger mb-0" data-target="#formApplication" data-toggle="modal"
                               data-placement="top" title="Click here to verify"><i
                                    class="text-danger mdi mdi-alert mdi-18px mr-2"></i>Not Verified</a>
                        </li>
                        <%
                            }
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-bottom-0">
                        <h5 class="modal-title text-primary" id="exampleModalLabel">Upload your business license to
                            verify</h5>
