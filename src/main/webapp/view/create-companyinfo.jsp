                ...
                <div class="custom-form p-4 border rounded">
                    ...
                    <form action="/FuJob/MainController" method="POST" enctype="multipart/form-data">
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group app-label">
                                    ...
                                    <input onchange="checkValidation()" id="Website" name="website" type="text"
                                           class="form-control resume" required="" placeholder="Website :"
                            ...
                            <div class="col-md-4">
                                <div class="form-group app-label">
                                    ...
                                    <input onchange="checkValidation()" id="Email" name="gmail" type="email"
                                           class="form-control resume" required="" placeholder="Gmail :"
                                           value="${requestScope.COMPANYINFO.gmail}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group app-label">
                                    ...
                                    <input onchange="checkValidation()" id="Phone" name="phone" type="tel"
                                           class="form-control resume" required="" placeholder="Phone: "
                                           value="${requestScope.COMPANYINFO.phone}">
                        ...
                        <div class="col-12 mt-4">
                            <input type="hidden" id="btnCreateCom1" name="action" class="submitBnt btn btn-primary"
                                   value="Create CompanyInfo">
                            <input type="submit" id="btnCreateCom" class="submitBnt btn btn-primary"
                                   value="Submit Company Info">
                        </div>
                    </form>
                </div>
            </div>
