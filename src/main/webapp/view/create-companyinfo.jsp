                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group app-label">
                                            ...
                                            <input id="Website" name="website" type="text" class="form-control resume" required="" placeholder="Website :" value="${requestScope.COMPANYINFO.website}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group app-label">
                                            ...
                                            <input id="Gmail" name="gmail" type="email" class="form-control resume" required="" placeholder="Gmail :" value="${requestScope.COMPANYINFO.gmail}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group app-label">
                                            ...
                                            <input id="Phone" name="phone" type="tel" class="form-control resume" required="" placeholder="Phone: " value="${requestScope.COMPANYINFO.phone}">
                                        </div>
                                    </div>
