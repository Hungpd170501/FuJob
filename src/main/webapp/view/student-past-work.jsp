                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="job-list-button-sm text-right">
                                                    ...
                                                    <div class="mt-3">
                                                        <button onclick="getFeedBack('<%= jobOrder.getEvaluateCompletion().getRatingValue()%>', '<%= jobOrder.getEvaluateCompletion().getContent()%>')"
                                                                class="btn btn-sm btn-primary-outline"
                                                    ...
                                                    <div class="mt-3">
                                                        <button onclick="getJobApplicatonIDDispute(<%= jobOrder.getJobApplicationID()%>)"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="${pageContext.request.contextPath}/MainController">
                                            ...
                                            <input type="hidden" id="jobApplicationIDtoDispute" name="jobApplicationID"
                                                   value="">
