    ...
    <div class="container">
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu">
                ...
                <li></li>
                <li></li>
                <li><a href="/FuJob/view/index.jsp">Home</a></li>
                <li class="has-submenu">
                    <a href="javascript:void(0)">Jobs</a><span class="menu-arrow"></span>
                    <ul class="submenu">
                        <li><a href="/FuJob/view/job-list.jsp">Job List</a></li>
                        <li><a href="/FuJob//view/job-grid.html">Your List Job</a></li>
                    </ul>
                </li>

                <li>
                    <a href="/FuJob/view/about.jsp">contact</a>
                </li>
                <li></li>
                <li></li>
                <li></li>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="/FuJob/view/create-resume.jsp">Edit your resume</a></li>
                        <li><a href="/FuJob//view/candidates-profile.jsp">View your resume</a></li>
                    </ul>
                </li>
