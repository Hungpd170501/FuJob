...
<html lang="en" class="no-js">
    <head>
        <jsp:include page="./include/header.jsp">
            <jsp:param name="title" value="FuJob | Job List by ID"/>
        </jsp:include>
    </head>
    <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-4 pt-2">
                            ...
                            <div class="row"> 
                            <% List<Job> listJob = (List<Job>) request.getAttribute("LIST_JOB_BYID");
                                if (listJob != null) {
                                    if (listJob.size() > 0) {
                                        for(Job job: listJob ){                           
                            %>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="job-list-button-sm text-right">
                                                    ...
                                                    <div class="mt-3">
                                                        <a href="#" class="btn btn-sm btn-primary">View candidate</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
